...
class Code
{
	...
	public $code;
	//验证码的随机种子
	public $codeStr='123456789abcdefghijkmnpqrstuwsy';
	//验证码长度
	public $codeLen=4;
	//验证码字体
	public $font="";
    ...
    private function createFont() {
        ...
        for ($i = 0; $i < $this->codeLen; $i++) {
            ...
            imagettftext($this->img, $this->fontSize, mt_rand(- 10, 10), $x * $i + mt_rand(6, 10), mt_rand($this->height / 1.3, $this->height - 5), $fontColor, $this->font, $this->code [$i]);
        }
